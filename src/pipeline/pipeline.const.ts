...
type Pipeline = (accountId: string) => LoadConfig;

export const Location: Pipeline = (accountId: string) => ({
...
export const Insight: Pipeline = (accountId: string) => ({
...
export const Review: Pipeline = (accountId: string) => ({
